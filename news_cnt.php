...
<section class="row news-cnt">
	<div class="wrapper s">
		<header>
			<h2 class="news-title">【閱讀活動】新北市同榮國小，作家李儀婷：「創意閱讀與寫作」</h2>
...
<section class="row news-cnt-foot">
	<div class="wrapper">
		<header><h3>更多訊息</h3></header>
		<div class="container_12">
			<ul class="news-list cf">
				<li class="news-item col-style1-6"><a href="news_cnt.php">
					<div class="news-item-block">
						<h2 class="news-title">樂利國小「愛閱­夢想館」學生讚校園誠品，突破K書中心的老設施</h2>
						<p class="news-shrink_text">
							<?php 
								// 來自：config.php
								content_show_length("庫巴」是鄒族傳統部落社會中的政治、經濟、宗教活動的核心，只有在大社才允許建築，目前在阿里山僅存達邦、特富野兩地有庫巴。鄒族視庫巴為神聖之地，外人、鄒族的女人、蔥、魚都禁止進入庫巴。最初，庫巴是氏族確立土地所有庫巴」是鄒族傳統部落社會中的政治、經濟、宗教活動的核心，只有在大社才允許建築，目前在阿里山僅存達邦、特富野兩地有庫巴。鄒族視庫巴為神聖之地，外人、鄒族的女人、蔥、魚都禁止進入庫巴。最初，庫巴是氏族確立土地所有", 105);
							 ?>
						</p>
						<div class="news-date">2015.04.04</div>
					</div>
...
$(function(){
	...
	$(".js-subNavItem4").addClass('active');
