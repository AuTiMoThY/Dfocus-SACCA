...
<div class="wrapper">
	...
	<ul class="resource-list cf">
		<li class="resource-item container_12">
			<div class="col-style1-9">
				<div class="resource-title col-style1-8 txt-gr1">【慶典童話系列】夜弄土地公</div>
				<div class="resource-people col-style1-4 txt-r4">
					<svg class="icon svg_icon_people">
			...
			<div class="col-style1-3">
				<div class="resource-download col-style1-6 txt-gr1"><a href="" target="_blank">
					<svg class="icon svg_icon_download">
		...
		<li class="resource-item container_12">
			<div class="col-style1-9">
				<div class="resource-title col-style1-8 txt-gr1">【童話搜神記】舞啦啦變城隍</div>
				<div class="resource-people col-style1-4 txt-r4">
					<svg class="icon svg_icon_people">
					  <use xlink:href="#shape-people"></use>
					</svg>
		...
		<li class="resource-item container_12">
			<div class="col-style1-9">
				<div class="resource-title col-style1-8 txt-gr1">【慶典童話系列】菜刀小子的陣頭夢</div>
				<div class="resource-people col-style1-4 txt-r4">
					<svg class="icon svg_icon_people">
					  <use xlink:href="#shape-people"></use>
					</svg>
